...
public class UpVoteService {
	public static JSONObject upVoteComment(String key, String objectId) {
		...
		try {
			...
			while (cursor.hasNext()) {
				BasicDBObject updateVote = new BasicDBObject().append("$inc", new BasicDBObject().append("votes.$.up", 1));
